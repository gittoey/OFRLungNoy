...
$sql = "SELECT `SubDistrict`.* FROM `SubDistrict` WHERE `SubDistrict`.`DistrictID` = {$mysqli->real_escape_string($_POST["DistrictID"])}";
$sql .= " ORDER BY `SubDistrict`.`NameInThai` ASC";
...
$_POST["Return"]["SubDistrict"] = $dataReturn;
